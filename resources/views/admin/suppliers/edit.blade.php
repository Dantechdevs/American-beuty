...
<div class="page-header" style="margin-bottom:1.5rem">
    <div>
        <h1 class="page-title">
            <i class="fas fa-pencil" style="color:var(--purple)"></i> Edit Supplier
        </h1>
        <p class="page-sub">{{ $supplier->name }} · {{ $supplier->purchases_count }} purchases</p>
    </div>
...
<div style="max-width:640px">
    <div style="background:#fff;border:1.5px solid var(--border);border-radius:var(--r);box-shadow:var(--shadow);overflow:hidden">
        ...
        <form method="POST" action="{{ route('admin.supplier.update', $supplier->id) }}" style="padding:1.25rem">
            @csrf @method('PUT')
