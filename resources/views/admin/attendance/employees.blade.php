            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:.8rem;color:var(--muted);white-space:nowrap">
                        @if($emp->joined_date)
                            {{ \Carbon\Carbon::parse($emp->joined_date)->format('d M Y') }}
                        @else
    ...
    <div class="em-modal">
        ...
        <form method="POST" id="editForm" enctype="multipart/form-data">
            ...
            <div class="em-grid-2">
                ...
                <div class="em-field">
                    <label class="em-label">PIN (4 digits)</label>
...
/* ── Edit modal ── */
function openEditModal(id, name, email, phone, pin, role, shiftId, joinedDate) {
