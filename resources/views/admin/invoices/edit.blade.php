...
<div class="page-header" style="margin-bottom:1.5rem">
    <div style="display:flex;align-items:center;gap:.75rem">
        <a href="{{ route('admin.invoices.show', $invoice) }}" class="btn btn-outline btn-sm"><i class="fas fa-arrow-left"></i></a>
        <div>
            <div class="page-title"><i class="fas fa-pen" style="color:var(--purple)"></i> Edit Invoice</div>
            <div class="page-sub">{{ $invoice->invoice_number }}</div>
        </div>
    </div>
</div>
...
<div style="display:grid;grid-template-columns:1fr 300px;gap:1.25rem;align-items:start">
            ...
            <div class="card-body">
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
                    <div class="form-group" style="grid-column:span 2">
                        ...
                        <input type="text" name="client_name" class="form-control" value="{{ old('client_name', $invoice->client_name) }}" required placeholder="e.g. Jane Doe">
                    </div>
    ...
    <div style="display:flex;flex-direction:column;gap:1rem">
                ...
                <div style="display:flex;flex-direction:column;gap:.6rem">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;font-size:.85rem">
                        ...
                        <input type="number" name="discount" id="discountInput" class="form-control"
                            ...
                            value="{{ old('discount', $invoice->discount) }}" min="0" step="0.01" oninput="recalc()">
                    </div>
                    <div style="display:flex;justify-content:space-between;align-items:center;font-size:.85rem">
                        <span style="color:var(--muted)">Tax (VAT)</span>
                        <input type="number" name="tax" id="taxInput" class="form-control"
                            style="width:110px;padding:.3rem .6rem;font-size:.82rem;text-align:right"
                            value="{{ old('tax', $invoice->tax) }}" min="0" step="0.01" oninput="recalc()">
                    </div>
        ...
        <a href="{{ route('admin.invoices.show', $invoice) }}" class="btn btn-outline" style="width:100%;justify-content:center">Cancel</a>
    </div>
</div>
</form>
