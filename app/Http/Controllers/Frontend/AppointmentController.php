...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // -- SMS: notify client that booking was received --------------
        $this->sendBookingReceivedSms($appointment);
    ...
    // -- SMS: booking received (sent immediately on booking) ----------
    private function sendBookingReceivedSms(Appointment $appointment): void
    {
        $message = "Hi {$appointment->client_name}! 💜\n"
            . "Your booking at American Beauty has been received.\n"
            . "Service: {$appointment->service_name}\n"
            . "Date: {$appointment->appointment_date->format('M d, Y')} at {$appointment->appointment_time}\n"
            . "We'll confirm your appointment shortly. Questions? Call us anytime.";
