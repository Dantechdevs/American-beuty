...
return [
    ...
    'stores' => [
        ...
        'database' => ['driver' => 'database', 'connection' => env('CACHE_DATABASE_CONNECTION'), 'table' => env('CACHE_DATABASE_TABLE', 'cache'), 'lock_connection' => env('CACHE_DATABASE_LOCK_CONNECTION'), 'lock_table' => env('CACHE_DATABASE_LOCK_TABLE')],
